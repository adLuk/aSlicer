 ...
 */
public class ThreeMfSerializer implements ModelSerializer<ThreeMfModel> {

    /**
     * Serializes the given {@link ThreeMfModel} into the specified binary output channel.
     ...
     */
    @Override
    public void serialize(ThreeMfModel model, WritableByteChannel channel) throws IOException {
