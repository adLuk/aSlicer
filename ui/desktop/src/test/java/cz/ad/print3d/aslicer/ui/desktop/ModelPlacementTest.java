        ...
        new HeadlessApplication(new ApplicationAdapter() {
            ...
            public void create() {
                try {
                    ...
                    app.modelManager.placeNearExisting(inst1);
                    app.modelManager.getInstances().add(inst1);
                    ...
                    app.modelManager.placeNearExisting(inst2);
                    ...
                    app.modelManager.getInstances().add(inst2);
                    ...
                    app.modelManager.placeNearExisting(inst3);
