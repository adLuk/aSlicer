...
public class DesktopUITest {
    ...
    @Test
    void testSkinHasRequiredStyles() throws InterruptedException {
        HeadlessApplicationConfiguration config = new HeadlessApplicationConfiguration();
        CountDownLatch latch = new CountDownLatch(1);
        final boolean[] success = {false};
        ...
        new HeadlessApplication(new ApplicationAdapter() {
            ...
            public void create() {
                try {
                    ...
                    assertNotNull(skin.get(Button.ButtonStyle.class), "Skin should have default ButtonStyle");
                    assertNotNull(skin.get(com.badlogic.gdx.scenes.scene2d.ui.TextButton.TextButtonStyle.class), "Skin should have default TextButtonStyle");
                    assertNotNull(skin.get(com.badlogic.gdx.scenes.scene2d.ui.Label.LabelStyle.class), "Skin should have default LabelStyle");
                    assertNotNull(skin.get(com.badlogic.gdx.scenes.scene2d.ui.TextField.TextFieldStyle.class), "Skin should have default TextFieldStyle");
                    assertNotNull(skin.get(com.badlogic.gdx.scenes.scene2d.ui.CheckBox.CheckBoxStyle.class), "Skin should have default CheckBoxStyle");
                    assertNotNull(skin.get(com.badlogic.gdx.scenes.scene2d.ui.List.ListStyle.class), "Skin should have default ListStyle");
                    assertNotNull(skin.get(com.badlogic.gdx.scenes.scene2d.ui.ScrollPane.ScrollPaneStyle.class), "Skin should have default ScrollPaneStyle");
                    assertNotNull(skin.get(com.badlogic.gdx.scenes.scene2d.ui.Window.WindowStyle.class), "Skin should have default WindowStyle");
                    assertNotNull(skin.get(com.badlogic.gdx.scenes.scene2d.ui.ImageButton.ImageButtonStyle.class), "Skin should have default ImageButtonStyle");
